...
class Binarizer(nn.Module):
    def __init__(self):
        ...
        self.conv = nn.Conv2d(512, 32, kernel_size=1, bias=False)    # changed output channels from 32 to 16
        self.sign = Sign()
...
class DecoderCell(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(
            32, 512, kernel_size=1, stride=1, padding=0, bias=False)   # changed input channels from 32 to 16 to accomodate the above change
        self.rnn1 = ConvLSTMCell(
            512,
            512,
            kernel_size=3,
